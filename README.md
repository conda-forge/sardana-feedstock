...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sardana-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sardana-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sardana sardana-core sardana-qt
# for installing globally
pixi global install sardana sardana-core sardana-qt
```
...
It is possible to list all of the versions of `sardana` available on your platform:
...
```
pixi search sardana --channel conda-forge
```
